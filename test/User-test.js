...
describe('User', () => {
  ...
  it.skip('should have an email address', () => {
    //  ADDED TEST:
    // expect(user.name).to.be.a('string');
  ...
  it.skip('getFirstName should return the first name of the user', () => {
    //  ADDED TEST:
    // expect(user.name).to.be.a('string');
  ...
  //   })
  //   it.skip('should update user\'s quality of sleep record', function() {
  //     expect(user.sleepQualityRecord.length).to.equal(3);
  //   });
  //   it.skip('should update user\'s average hours of sleep', function() {
  //     expect(user.hoursSleptAverage).to.equal('7.0');
  //   });
  //   it.skip('should update user\'s average quality of sleep', function() {

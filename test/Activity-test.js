...
describe('Activity', function() {
  ...
  it.skip('should hold a userId', function() {
    expect(activity2.userId).to.equal(2);
  });
  it.skip('should hold a date', function() {
    expect(activity1.date).to.equal("2019/06/15");
  });
  it.skip('should hold number of steps', function() {
    expect(activity1.steps).to.equal(3684);
  });
  it.skip('should hold minutes active', function() {
    expect(activity2.minutesActive).to.equal(280);
  });
  it.skip('should hold flights of stairs', function() {
  ...
  it.skip('doActivity should add activities to user record', function() {
...
it.skip('findFriendsNames should find the first names of friends', function() {
  let user2 = new User({
    'id': 16,
    'name': 'Ben Nist',
  })
...
it.skip('findFriendsTotalStepsForWeek should find friends\' total steps', function() {
  let user2 = new User({
    'id': 16,
    'name': 'Ben Nist',
  })
...
// it.skip('calculateAverageStepGoal should return average step goal for all users', function() {
